package co.ncleguizamon.springboot.webflux.app;
...
public class SpringBootReactorApirestApplication implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(SpringBootReactorApirestApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringBootReactorApirestApplication.class, args);
	}
	@Override
